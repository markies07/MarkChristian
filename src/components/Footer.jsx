    ...
    return (
        <div className='bg-title py-2 flex flex-col items-center'>
            ...
            <div className='flex font-poppins text-xs font-medium justify-between w-full px-10 pt-3 max-w-[50rem]'>
                ...
                <a href='https://www.linkedin.com/in/mark-naval-68426a252/' target='_blank' rel='noopener noreferrer' className='cursor-pointer px-2 py-1 hover:underline'>LINKEDIN</a>
            </div>
