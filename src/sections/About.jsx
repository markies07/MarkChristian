        ...
        <div id='about' className='relative z-10  mt-[100vh] text-gray bg-transparent pt-16'>
            <div className='bg-white rounded-t-[3rem] py-8 px-3'>
                ...
                <div className='py-5 relative font-anton flex flex-col justify-center'>
                    ...
                    <h1 className='text-center text-gray text-[24vw] lg:text-[17vw] xl:text-[14vw] 2xl:text-[12vw] text leading-[0.90] pb-[33vw] sm:pb-[32vw] lg:pb-[25vw] xl:pb-[22vw] 2xl:pb-[19vw]'>CHRISTIAN</h1>
                    {/* PICTURES */}
                    <div className='absolute bottom-[22vw] lg:bottom-[15vw] xl:bottom-[13vw] 2xl:bottom-[11vw] w-full flex justify-center'>
                        {/* <TiltCard>
                        ...
                        <div className='relative flex justify-center '>
                           <TiltCard>
                                <div className="relative w-[30vw] z-10 lg:w-[25vw] xl:w-[20vw] 2xl:w-[18vw] -rotate-12 -top-10 left-5">
                                    <img src={img1} alt="" className='w-full h-auto rounded-md' />
                                </div>
                            </TiltCard>
                            <TiltCard>
                                <div className="relative w-[30vw] z-30 lg:w-[25vw] xl:w-[20vw] 2xl:w-[18vw]">
                                    <img className='w-[30vw] lg:w-[25vw] z-20 xl:w-[20vw] 2xl:w-[18vw]' src={img2} alt="" />
                                </div>
                            </TiltCard>
                            <TiltCard>
                                <div className="relative w-[30vw] z-10 lg:w-[25vw] xl:w-[20vw] 2xl:w-[18vw] -top-10 rotate-12 right-5">
